# Base Vagrant Setup - running centos7 cockroachdb v20.2.7
...
```
[~/projects/vagrant-centos7-cockroachdb] vagrant up
...
the [provision.sh](provision.sh) script (triggered when the VM is initially built), includes steps to install cockroachDB as per https://www.cockroachlabs.com/docs/stable/install-cockroachdb-linux.html
